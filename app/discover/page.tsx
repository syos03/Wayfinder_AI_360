    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        >
          ...
          >
            <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-3 h-auto bg-muted/50 backdrop-blur-sm border border-border/50">
              <TabsTrigger 
                value="for-you" 
              ...
              <Card className="card-premium-hover h-full group">
                <CardContent className="p-8 text-center">
                  <motion.div
                    ...
                    className={`w-20 h-20 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl`}
                  >
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <motion.h3 variants={fadeInUp} className="text-3xl md:text-4xl font-bold mb-3">
              ...
              <Card className="card-premium-hover cursor-pointer overflow-hidden h-full">
                <CardContent className={`p-6 text-center bg-gradient-to-br ${tag.color} text-white relative overflow-hidden`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <h4 className="font-bold text-lg mb-2">{tag.name}</h4>
                    <p className="text-sm opacity-90">{tag.count} điểm đến</p>
                  </div>
                </CardContent>
              </Card>
            </motion.a>
