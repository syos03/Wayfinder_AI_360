...
import { Sparkles, MapPin, ArrowRight, Compass, Users, Star, ChevronDown } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-screen flex items-center justify-center px-6 py-24 overflow-hidden bg-background"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="block mt-2 text-foreground/80 text-5xl md:text-6xl lg:text-7xl">
                Thông Minh
              </span>
            </motion.h1>
            ...
            >
              <Button size="lg" className="text-base px-10 py-6 btn-gradient group" asChild>
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base px-10 py-6 border-2 hover:bg-primary/5 hover:border-primary/50 transition-all"
                asChild
              >
                <Link href="/explore">
          ...
          >
            ...
            <FloatingCard delay={0.4} className="absolute top-0 right-0 w-64">
              <Card className="card-premium-hover bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            ...
            <FloatingCard delay={0.5} className="absolute top-32 left-0 w-56">
              <Card className="card-premium-hover bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
                <CardContent className="p-6 text-center">
                  <div className="w-14 h-14 bg-gradient-to-br from-primary to-primary/70 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg">
            ...
            <FloatingCard delay={0.6} className="absolute bottom-32 right-0 w-60">
              <Card className="card-premium-hover bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
                <CardContent className="p-6 text-center">
                  <div className="w-14 h-14 bg-gradient-to-br from-primary to-primary/70 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg">
