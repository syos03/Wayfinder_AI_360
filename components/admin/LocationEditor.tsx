  ...
  return (
    <div className="space-y-4">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-blue-900 mb-1">Chỉnh sửa vị trí: {destinationName}</h3>
            <p className="text-sm text-blue-700 mb-2">Kéo thả marker để thay đổi vị trí</p>
      ...
      <div className="flex gap-3">
        <Button onClick={handleSave} disabled={!hasChanged || isSaving} className="flex-1">
          <Save className="w-4 h-4 mr-2" />
          {isSaving ? 'Đang lưu...' : 'Lưu vị trí mới'}
        </Button>

        <Button onClick={handleReset} variant="outline" disabled={!hasChanged || isSaving}>
      ...
      <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded">
        <strong>Mẹo:</strong> Click và giữ chuột vào marker, sau đó kéo đến vị trí mong muốn.
